...
import org.apache.pekko.actor.typed.{ActorSystem, MailboxSelector}
import org.apache.pekko.actor.typed.scaladsl.Behaviors
import org.apache.pekko.dispatch.{ControlMessage, PriorityGenerator, UnboundedPriorityMailbox}
...
object MailboxesDemo {
  ...
  class SupportTicketPriorityMailbox(settings: org.apache.pekko.actor.ActorSystem.Settings, config: Config)
